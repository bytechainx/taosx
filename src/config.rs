...
fn de_optional_precision<'de, D>(deserializer: D) -> Result<Option<TsPrecision>, D::Error>
where
    D: serde::Deserializer<'de>,
{
...
fn de_transport<'de, D>(deserializer: D) -> Result<TransportMode, D::Error>
where
    D: serde::Deserializer<'de>,
{
...
fn env_parsed<T>(name: &str) -> TaosResult<Option<T>>
where
    T: std::str::FromStr,
{
...
fn env_bool(name: &str) -> TaosResult<Option<bool>> {
