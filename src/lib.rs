...
//!
//! 本 crate 把 TDengine 访问能力收敛为一组可独立发布、零内部耦合的组件：
...
pub use config::{
    ...
    ENV_MAX_RESPONSE_BYTES, ENV_MAX_SUBTABLES_HINT, ENV_PASSWORD, ENV_PORT, ENV_PRECISION,
    ENV_PREFIX, ENV_TIMEOUT_MS, ENV_TLS, ENV_TLS_CA_FILE, ENV_TRANSPORT, ENV_USER,
    ENV_WRITE_MAX_ATTEMPTS, HARD_MAX_BATCH_BYTES, HARD_MAX_BATCH_ROWS, HARD_MAX_CLOSE_TIMEOUT,
